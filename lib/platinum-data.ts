...
#airfryer #ninjafoodi #instantpot #productreview #tiktokmademebuyit #kitchenhacks`,
  ...
  {
    id: 'comp-3',
    title: 'Dyson vs Shark Vacuum: Which $400+ Vacuum is Worth It?',
    category: 'Home',
    product1: {
    ...
    product2: {
      ...
      pros: [
        '$250 cheaper',
        'Better at pet hair',
        'Easier to empty dustbin',
        'Lighter weight',
      ],
    },
    winner: 1,
    verdict: 'The Dyson V15 is the better overall vacuum with its laser technology and superior suction. However, if you have pets and want to save $250, the Shark Vertex Pro is an excellent alternative that actually performs better on pet hair.',
    whenToChoose1: 'Choose Dyson V15 if you want the absolute best vacuum technology, have hardwood floors, and can afford the premium price.',
    whenToChoose2: 'Choose Shark Vertex if you have pets, are on a tighter budget, or prefer a lighter vacuum that is easier to maintain.',
  },
  {
    id: 'comp-4',
    title: 'iPad vs Samsung Galaxy Tab: Which Tablet Should You Buy in 2024?',
    category: 'Tech',
    product1: {
      name: 'iPad 10th Gen',
      asin: 'B0BJLXMVMV',
    ...
    product2: {
      ...
      rating: 4.6,
      pros: [
        'AMOLED display (better screen)',
        'S Pen included (iPad pencil $99 extra)',
        'Better multitasking',
        'MicroSD card slot',
      ],
    },
    winner: 1,
    verdict: 'For most people, the iPad is the better choice due to its superior app ecosystem, longer support, and better value. The Galaxy Tab S9 is excellent but costs more than double and only shines if you need the S Pen or prefer Android.',
...
export const bestOfLists: BestOfList[] = [
  ...
  {
    id: 'best-2',
    title: 'Top 5 Fitness Trackers Under $200 (2024 Buyers Guide)',
    subtitle: 'The best activity trackers ranked by accuracy, battery life, and features',
    category: 'Fitness',
    intro: 'I wore 12 different fitness trackers for months to find the best ones. These 5 stood out for accuracy, battery life, and actual useful features you will use daily.',
    products: [
      {
        rank: 1,
        ...
        pros: [
          '7-day battery life (no daily charging)',
          'Most accurate heart rate in its class',
          'Built-in GPS for running',
          'Google Maps and YouTube Music controls',
        ],
      },
      {
        rank: 2,
      ...
      },
      {
        ...
        pros: [
          '18-day battery life (longest tested)',
